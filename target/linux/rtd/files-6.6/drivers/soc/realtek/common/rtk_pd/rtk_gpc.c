...
#define GPC_FLAGS_IGNORE_ISO_PWR    0x0010 /* Don't set ISO power */
#define GPC_FLAGS_HWWDT_ISSUE       0x0020 /* Workarounds hardware watchdog issue */
#define GPC_FLAGS_IGNORE_SRAM_PWR   0x0040 /* Don't set sram power, alway return power on */
...
static inline int sram_power_ignored(struct rtk_gpc_data *data)
{
        return !!(data->cfg->flags & GPC_FLAGS_IGNORE_SRAM_PWR);
}
...
static const struct rtk_gpc_cfg rtd1619b_gpc_cfgs[] = {
	GPC_CFG("ve1", 0, 0),
	GPC_CFG("ve2", 1, GPC_FLAGS_IGNORE_ISO_PWR | GPC_FLAGS_IGNORE_SRAM_PWR),
